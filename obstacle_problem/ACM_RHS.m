function b = ACM_RHS(Eig_m, DET, n,k,c,U,LAP,sigma,eps,uexct,g_projected,f_projected, neumm)
if ~exist('neumm', 'var')
    neumm = 1;
end
...
kk = 0;
for ielm=1:n^2
    belem = ACM_localRHS_vol(n,k,ielm,c,U,LAP,f_projected,g_projected, DET, Eig_m);
    for i=1:Nloc
        ie = i + kk;
        b(ie) = belem(i);
    end
